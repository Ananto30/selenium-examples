...
def parse(url):
    searchKey = "Paris"  # Change this to your city
    checkInDate = '27/02/2018'  # Format %d/%m/%Y
    checkOutDate = '29/02/2018'  # Format %d/%m/%Y
    response = webdriver.Chrome("C:/chromedriver_win32/chromedriver.exe")
    response.get(url)
